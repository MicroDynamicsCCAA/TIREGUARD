...
;		Function LIN_DEACTIVATE_ANTENNA neu hinzugefügt
...
;
;begin 25.02.2015
fRX1Enable:	equ	_true		;= _true :  Empfangsantenne 1 (vorne links)
					;	    wird abgefragt
					;
					;= _false : Empfangsantenne 1 wird nicht
;					;	    abgefragt, nur der Trigger 1 ist aktiv
;end
;
					;
;------------------------------------------------------------------------------
...
;
;begin 25.02.2015
	xdef	LIN_DEACTIVATE_ANTENNA	;Code
;end
;
	xdef	LIN_START		;Code
	xdef	LIN_RUN			;Code
...
;begin 25.02.2015
;------------------------------------------------------------------------------
;Public: LIN_DEACTIVATE_ANTENNA setzt das Antennenflag an der durch das 
;A-Register übergebenen Position zurück.
;
;Eingangsparameter:	A		Antennenposition
;Ausgangsparameter:	ANTENNA_FLAGS
;veränderte Register:	CCR
;------------------------------------------------------------------------------
					;
LIN_DEACTIVATE_ANTENNA:
	CMPA	#8			;Antennenposition auf zulässigen Wertebereich prüfen
	BHS	LIN_DEACTIVATE_ANTENNA9	;
					;
	PSHX				;Register retten
					;
	LDX	#ANTENNA_TBL		;
	LDAA	A,X			;Zeiger in Positionsmaskentabelle
	COMA				;
	ANDA	ANTENNA_FLAGS		;Antenne deaktivieren
	STAA	ANTENNA_FLAGS		;
					;
	PULX				;Register restaurieren
					;
LIN_DEACTIVATE_ANTENNA9:
	RTS				;
					;
;end
;
