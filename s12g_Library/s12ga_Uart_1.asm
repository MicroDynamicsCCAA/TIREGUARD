...
;Update:	27.11.2014
;
;Description:	Funktionen für die serielle RS232-Kommunikation über SCI1,
...
;
;24.04.2010	Konstante für Baudraten-Reloadwert umbenannt
...
;------------------------------------------------------------------------------
					;
SCI_TX_DISABLE:
	BCLR	SCI1CR2,_TE		;_TE rücksetzen
	RTS				;
					;
;------------------------------------------------------------------------------
