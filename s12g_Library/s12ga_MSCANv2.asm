	...
	title	"s12ga_MSCANv2  Copyright (C) 2005-2019, micro dynamics GmbH"
;------------------------------------------------------------------------------
;Module:	s12ga_MSCANv2.asm
;
;Copyright:	(C) 2005-2019, micro dynamics GmbH
...
;
;02.03.2019	Korrektur in CANx_TX_INT und CANx_RX_INT
;
;02.10.2016     Handhabung der Empfangs-Akzeptanzfilter überarbeitet:
...
;Laufzeit:		ca. 1,2 µs bei Identifier = [7F8h..7FFh]
;			sonst max. 12 µs @ 24 MHz
;------------------------------------------------------------------------------
					;
CAN0_RX_INT:
