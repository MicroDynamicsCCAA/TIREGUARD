	...
	include	"s12ga_DS1722.sfr"
	title	"s12ga_DS1722  Copyright (C) 2005-2014, micro dynamics GmbH"
;------------------------------------------------------------------------------
;Module:	s12ga_DS1722_a.asm
;
...
;
;Folgende Bezeichner sind in s12ga_DS1722.sfr zu definieren:
;
;Switches:	fEnabled
;
;Bits:		_MISO
