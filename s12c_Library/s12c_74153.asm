	...
	include	"s12c_74153.sfr"
	title	"s12c_74153  Copyright (C) 2007, micro dynamics GmbH"
;------------------------------------------------------------------------------
;Module:	s12c_74153.asm
;
;Copyright:	(C) 2007, micro dynamics GmbH
...
;
;Folgende Bezeichner sind in s12c_74153.sfr zu definieren:
;
;Bits:		_A
;		_B
;
...
MUX_RESET:
	...
	LDY	#MUX_PORT		;
	LDAA	0,Y			;
	ANDA    #~(_A | _B)		;Multiplexer in Zustand 0 schalten
	STAA	0,Y			;
	RTS				;
					;
;//////////////////////////////////////////////////////////////////////////////
