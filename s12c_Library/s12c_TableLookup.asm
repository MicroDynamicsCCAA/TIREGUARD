	...
	title	"s12c_TableLookup  Copyright (C) 2006-2018, micro dynamics GmbH"
;------------------------------------------------------------------------------
;Module:	s12c_TableLookup.asm
;
;Copyright:	(C) 2006-2018, micro dynamics GmbH
...
;
;16.02.2018	Korrektur: Nach Differenzbildung den ersten Tabellenwert wiederherstellen
;12.01.2018	Tabellenwerte dürfen nun auch negativ sein
;
...
;------------------------------------------------------------------------------
					;
	xref	MUL3216U		;Code	s12c_Arithmetics.asm
	xref	DIV3216U		;Code	s12c_Arithmetics.asm
					;
.text:		section
					;
;------------------------------------------------------------------------------
...
;begin 12.01.2018
	...
	TST	R12			;
	BPL	EXPAND_V1_1		;vorzeichenrichtig auf 32-bit erweitern
	LDY	#0FFFFh			;
	BRA	EXPAND_V1_2		;
EXPAND_V1_1:
	LDY	#0			;
EXPAND_V1_2:
	...
	TST	R22			;
	BPL	EXPAND_V2_1		;vorzeichenrichtig auf 32-bit erweitern
	LDY	#0FFFFh			;
	BRA	EXPAND_V2_2		;
EXPAND_V2_1:
	LDY	#0			;
...
;
;begin 12.02.2018
	LDAA	R10			;für den Vergleich
	EORA	#80h			;Vorzeichenbit des ersten Tabellenwertes umkehren
	STAA	R10			;
	LDAA	R20			;
	EORA	#80h			;Vorzeichenbit des zweiten Tabellwertes umkehren
	STAA	R20			;
;end
;
	LDD	R22			;
	...
	LDD	R20			;
	SBCB	R11			;
	SBCA	R10			;Differenz der Tabellenwerte in R[0..3]
	STD	R0			;
;
;begin 16.02.2018
	LDAA	R10			;Ursprungszustand des ersten Tabellenwertes
	EORA	#80h			;wiederherstellen
	STAA	R10			;nur erster Tabellenwert wird noch benötigt
;end
;
