	...
	title	"s12c_DS1722_sl  Copyright (C) 2005-2009, micro dynamics GmbH"
;------------------------------------------------------------------------------
;Module:	s12c_DS1722_sl.asm
;
;Copyright:	(C) 2005-2009, micro dynamics GmbH
...
;		geschrieben werden.
;
;		Im Unterschied zu s12c_DS1722_s.asm ist _CE hier Low Active!
;
...
;
;20.05.2009	_CE ist hier Low Active!
;
